...
@rx.page(route="/aseo", on_load=State.get_trabajadores_by_categoria("Aseo"))
@template
def aseo() -> rx.Component:
    """Página principal de aseo con tarjetas para cada usuario."""
    return rx.vstack(
        rx.heading("aseo", icon="wrench"),  
        rx.hstack(
