...
@rx.page(route="/electricistas", on_load=State.get_trabajadores_by_categoria("Electricistas"))
@template
def electricistas() -> rx.Component:
    """Página principal de electricistas con tarjetas para cada usuario."""
    return rx.vstack(
        rx.heading("electricistas", icon="wrench"),  
        rx.hstack(
